...
# Paths
label_file_path = os.path.expanduser('/home/to/ECGLLM/Validations/ecg_metadata_label.csv')
# data_path = os.path.expanduser('/home/to/ECGLLM/Validations/records_pred')
# data_path = os.path.expanduser('~/HOME/dinov/output')
data_path = os.path.expanduser('/home/to/ECGLLM/Validations/records_moirai')
...
# # Paths
# label_file_path = os.path.expanduser('/home/to/ECGLLM/Validations/ptbxl_ecg_data_label.csv')
# data_path = os.path.expanduser('/home/to/ECGLLM/Validations/ptbxl_moirai')
